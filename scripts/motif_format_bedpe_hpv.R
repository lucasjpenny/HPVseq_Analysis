...
### Write file
write.table(bedpe_1, file.path(outdir, paste0(id, "_fasta_5.bed")), sep = "\t", row.names = FALSE, col.names = FALSE, quote = FALSE)
write.table(bedpe_2, file.path(outdir, paste0(id, "_fasta_3.bed")), sep = "\t", row.names = FALSE, col.names = FALSE, quote = FALSE)
